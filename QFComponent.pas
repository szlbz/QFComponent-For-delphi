...
type
  ...
  TCustomText = class(TCustomControl)//TGraphicControl)
  private
    FTextHeigth:integer;
...
begin
  ...
  begin
    ...
    begin
      s1:=copy(str,i,1);
      if (s1='<') and (copy(str,i+1,1).ToUpper='S') and (copy(str,i+2,1).ToUpper='U')
         and (copy(str,i+3,1).ToUpper='P') and (copy(str,i+4,1)='>') then
      begin
      ...
      if (s1='<') and (copy(str,i+1,1).ToUpper='S') and (copy(str,i+2,1).ToUpper='U')
         and (copy(str,i+3,1).ToUpper='B') and (copy(str,i+4,1)='>') then
      begin
        Buffer.Canvas.font.Size:=NewFontSize;//下标
        i:=i+5;
      end
      else
      if (s1='<') and (copy(str,i+1,1).ToUpper='/')  and (copy(str,i+2,1).ToUpper='S')
         and (copy(str,i+3,1).ToUpper='U')
         and (copy(str,i+4,1).ToUpper='P') and (copy(str,i+5,1)='>') then
      begin
      ...
      if (s1='<') and (copy(str,i+1,1).ToUpper='/')  and (copy(str,i+2,1).ToUpper='S')
         and (copy(str,i+3,1).ToUpper='U')
         and (copy(str,i+4,1).ToUpper='B') and (copy(str,i+5,1)='>') then
      begin
        Buffer.Canvas.font.Size:=oldFontSize;//取消下标
        i:=i+6;
      end
      else
      if (s1='<') and (copy(str,i+1,1)='!') and (copy(str,i+2,1)='>') then
      begin
      ...
      if (s1='<') and (copy(str,i+1,1).ToUpper='C') then
      begin
        if (copy(str,i+2,1)='1') and (copy(str,i+3,1)='>') then i:=i+4;
        if (copy(str,i+2,1)='2') and (copy(str,i+3,1)='>') then i:=i+4;
        if (copy(str,i+2,1)='3') and (copy(str,i+3,1)='>') then i:=i+4;
        if (copy(str,i+2,1)='4') and (copy(str,i+3,1)='>') then i:=i+4;
        if (copy(str,i+2,1)='5') and (copy(str,i+3,1)='>') then i:=i+4;
      end
      else
      if (s1='<') and (copy(str,i+1,1)='/') and (copy(str,i+2,1).ToUpper='C')
         and (copy(str,i+3,1)='>') then
      begin
        i:=i+4;
      end
      else
...
begin
  ...
  begin
    ...
    begin
      ...
      FLineList[i].str:=s;
      FBuffer.Canvas.Font.Size:=FLineList[i].FontSize;
      FLineList[i].LineHeight:=FBuffer.Canvas.TextHeight(s)+5;
...
begin
  Result:=copy(str,i,1);
  j:=0;
  if (Result='<') and (copy(str,i+1,1).ToUpper='S') and
     (copy(str,i+2,1).ToUpper='U') and
     (copy(str,i+3,1).ToUpper='P') and
     (copy(str,i+4,1)='>') then
  begin
    Result:='';
    j:=5;
  ...
  if (Result='<') and (copy(str,i+1,1).ToUpper='/') and
     (copy(str,i+2,1).ToUpper='S') and
     (copy(str,i+3,1).ToUpper='U') and
     (copy(str,i+4,1).ToUpper='P') and
     (copy(str,i+5,1)='>') then
  begin
    Result:='';
    j:=6;
  ...
  if (Result='<') and (copy(str,i+1,1)='#') and (copy(str,i+2,1)='>') then
  begin
    Result:='';
    j:=3;
  end
  ...
  if (Result='<') and (copy(str,i+1,1).ToUpper='C') then
  begin
    if (copy(str,i+2,1)='1') and (copy(str,i+3,1)='>') then
    begin
       Result:='';
       j:=3;
    end;
    if (copy(str,i+2,1)='2') and (copy(str,i+3,1)='>') then
    begin
       Result:='';
       j:=3;
    end;
    if (copy(str,i+2,1)='3') and (copy(str,i+3,1)='>') then
    begin
       Result:='';
       j:=3;
    end;
    if (copy(str,i+2,1)='4') and (copy(str,i+3,1)='>') then
    begin
       Result:='';
       j:=3;
    end;
    if (copy(str,i+2,1)='5') and (copy(str,i+3,1)='>') then
    begin
       Result:='';
       j:=3;
    end;
  ...
  if (Result='<') and (copy(str,i+1,1)='/') and (copy(str,i+2,1).ToUpper='C') and (copy(str,i+3,1)='>') then
  begin
    Result:='';
    j:=4;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if (s1='<') and (copy(str,i+1,1).ToUpper='C') then
      begin
        if (copy(str,i+2,1)='1') and (copy(str,i+3,1)='>') then Buffer.Canvas.font.Color:=clBlack;
        if (copy(str,i+2,1)='2') and (copy(str,i+3,1)='>') then Buffer.Canvas.font.Color:=clRed;
        if (copy(str,i+2,1)='3') and (copy(str,i+3,1)='>') then Buffer.Canvas.font.Color:=clYellow;
        if (copy(str,i+2,1)='4') and (copy(str,i+3,1)='>') then Buffer.Canvas.font.Color:=clGreen;
        if (copy(str,i+2,1)='5') and (copy(str,i+3,1)='>') then Buffer.Canvas.font.Color:=clBlue;
        i:=i+4;
      end
      else
      if (s1='<') and (copy(str,i+1,1)='/') and (copy(str,i+2,1).ToUpper='C') and (copy(str,i+3,1)='>') then
      begin
...
begin
  ...
  begin
    Buffer.Canvas.MoveTo(FGapX,FOffset + y+FGapY+3+i*h);
    Buffer.Canvas.LineTo(Buffer.Width-FGapX,FOffset + y+FGapY+3+i*h);
  end;
  ...
  begin
    ...
    Buffer.Canvas.MoveTo(x0,y0);
    Buffer.Canvas.LineTo(x0,y1);
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      Buffer.Canvas.MoveTo(FGapX,FOffset + y+FGapY+3);
      Buffer.Canvas.LineTo(Buffer.Width-FGapX,FOffset + y+FGapY+3);
      y:=y+5;
    end
    else
    ...
    begin
      Buffer.Canvas.Pen.Color:=FLineList[i].FontColor;
      Buffer.Canvas.MoveTo(FGapX,FOffset + y+FGapY);
      Buffer.Canvas.LineTo(Buffer.Width-FGapX,FOffset + y+FGapY);
      Buffer.Canvas.MoveTo(FGapX,FOffset + y+FGapY+3);
      Buffer.Canvas.LineTo(Buffer.Width-FGapX,FOffset + y+FGapY+3);
      y:=y+5;
    end
...
procedure TCustomText.Paint;
begin
  inherited Paint;
  DrawScrollingText(self);
end;
...
begin
  ...
  begin
    ShellExecute(0, 'open',pchar(FLineList[FActiveLine].str) , nil, nil, 1);
...
procedure TQFRichView.WMMouseWheel(var Message: TCMMouseWheel);
begin
